    ...
    <div>
        <div class="home-main">
            <div class="content">
                ...
                <h3>Những món ăn vô cùng đơn giản nhưng lại thơm ngon lạ thường 😋</h3>
                <p>Chúng tôi cam kết sử dụng nguyên liệu tươi ngon nhất, mang đến chất lượng tuyệt vời trong từng món ăn. Khách hàng sẽ được thưởng thức những món ăn đậm đà, với những hương vị mạnh mẽ và tinh tế, làm hài lòng mọi giác quan.</p>
        ...
        <div class="home-about">
            ...
            <div class="content">
                ...
                <h3 class="title">Điều gì làm món ăn của chúng tôi trở nên ngon miệng!</h3>
                <p>Thực phẩm đến tay khách hàng luôn được đảm bảo chất lượng tốt nhất. Các món ăn của chúng tôi được chế biến bởi đầu bếp David (người đạt 5 sao Michelin), hứa hẹn mang đến hương vị bùng nổ, tinh tế và ấn tượng. Dịch vụ giao hàng của chúng tôi rất chuyên nghiệp, khách hàng có thể thưởng thức chất lượng như tại nhà hàng.</p>
